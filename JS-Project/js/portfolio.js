...
function parseData(data){
    ...
    {
        document.getElementById("projects").innerHTML += `<a href="/JS-Project/html/${data.projects[i].subdomain}.html"><div class="row project" id="${data.projects[i].subdomain}">
        <div class="projimg"><img src="/JS-Project/images/${data.projects[i].mainimg}"></div>
